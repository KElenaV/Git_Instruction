...
* необходимо создать файл *.gitignore* и записать в него названия игнорируемых файлов. Правила из .gitignore применяются только к новым файлам. Если файлы уже staged|commited .gitignore не будет к ним применяться.
